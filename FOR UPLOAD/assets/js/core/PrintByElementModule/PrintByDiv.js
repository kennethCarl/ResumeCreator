    ...
    return {
        ...
        controller: function ($scope) {
            ...
            $scope.printDiv = function (divId) {
                window.frames["print_frame"].document.head.innerHTML = '<style>ul{margin-bottom: 0px;}.left-label-preview{width: 16%; font-weight:bold; display:inline-block; }.right-label-preview {width: 84%;display: inline-block;}.right-label-preview-beside-image {width: 64%;display: inline-block;}.left-label-preview-medium{width: 17%;font-weight:bold;display:inline-block;margin-left: 2%;}.right-label-preview-medium{width: 81%;display:inline-block;}.line{min-width: 100%;text-align: justify;}.line-label-document{font-size: 120%; font-weight: bold;}.line-label-medium-document{font-size: 100%;font-weight: bold;margin-left: 10px;}.line-label-document1{font-size: 110%; font-weight: bold;}.line-label-medium-document1{font-size: 95%;font-weight: bold;margin-left: 10px;}.line-label-document2{font-size: 105%; font-weight: bold;}.line-label-medium-document2{font-size: 90%;font-weight: bold;margin-left: 10px;}.line-center{min-width: 100%;text-align: center;}</style>';
