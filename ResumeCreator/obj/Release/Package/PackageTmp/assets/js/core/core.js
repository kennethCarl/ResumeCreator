var arjocamahamageApp = angular.module('arjocamahamageResumeCreatorApp', ['LocalForageModule', 'ui.router', 'PrintModule'])

.config(['$localForageProvider', function ($localForageProvider) {
    $localForageProvider.config({
        name: 'ARJOCAMAHAMAGEAPP-MYRESUME', // name of the database and prefix for your data, it is "lf" by default
        version: 1.0, // version of the database, you shouldn't have to use this
        storeName: 'MYRESUME', // name of the table
        description: 'Contains user resume detail.'
    })
}])
...
arjocamahamageApp.run(function ($state, $rootScope, $interval) {
    ...
    //Prevent user to print the page
