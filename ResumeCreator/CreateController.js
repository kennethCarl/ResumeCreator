arjocamahamageApp.controller("CreateController", function ($http, $scope, $state, $interval, $filter, $rootScope) {
    ...
    $scope.links = [
                        ...
                        $rootScope.baseUrl + "/guide/mozilla_print_pdf1.JPG",
    ];
        ...
        switch (appName) {
            case "CutePDF":
                ...
                .success(function (data, status) {
                    window.open($scope.baseUrl + "api/fileupload?filename=CuteWriter.exe&token=@" + data.stringParam1, "_blank")
                })
        ...
        if (checkIfForNewPage) {
            ...
            for (var i = 0; i < data[1]; i++) {
                if(isParagraph == true && i == 0)
                    data[3].Lines[lineIndex] = '<div style="min-width: 97%; text-align: justify; margin-left: 3%;">' + wordsPerLine[i] + closingTag + "\n";
                else
    ...
    //        for (var i = 0; i < data[1]; i++) {
    //            if (isParagraph == true && i == 0)
    //                data[3].Lines[lineIndex] = '<div style="font-size: 90%;  min-width: 100%; text-align: justify; margin-left: 10px;">' + wordsPerLine[i] + closingTag + "\n";
    //            else
    //                data[3].Lines[lineIndex] = openingTag + wordsPerLine[i] + closingTag + "\n";
    //            lineIndex = lineIndex + 1;
    //        }
    ...
    //                    contentHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 100px; font-weight: bold;">Label</td><td style="width: auto;">Content</td></tr></table>\n';
    //                    contentHTML = contentHTML.replace("Content", holder);
    //                    contentHTML = contentHTML.replace("Label", label);
    //                    $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + contentHTML;
    //                } else {
    //                    holder = "&nbsp;" + forWrite[3].Lines[j];
    //                    contentHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 100px; font-weight: bold;"></td><td style="width: auto;">Content</td></tr></table>\n';
    //                    contentHTML = contentHTML.replace("Content", holder);
    //                    $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + contentHTML;
    //                }
    //            }
    ...
    //    var forWrite = $scope.generatePrintLines(content.toString(), $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="font-size: 90%;  min-width: 100%;text-align: center;">', "</div>");
    //    var holder = "";
    //    if (forWrite[0] == "New Page") {
    //        //Process current page
    //        if (forWrite[1] > 0) {
    ...
    //    $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + '<div style="font-size: 100%;  width: 550px; font-weight: bold;">Content</div>' + "\n";
    ...
    //    $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + '<div style="width: 550px; font-size: 90%;  font-weight: bold; margin-left: 10px;">Content</div>' + "\n";
    //    $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount].replace("Content", content);
    //};

    //$scope.initializePrintObjective = function (user, maxNoOfLines, maxCharacter) {
    //    var forWrite = $scope.generatePrintLines(user.Objectives, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify; font-size: 90%;  ">', "</div>", true);
    //    var holder = "";
    //    if (forWrite[0] == "New Page") {
    //        //Process current page
    //        if (forWrite[1] > 0) {
    ...
    //    var forWrite = $scope.generatePrintLines(user.Hobbies, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="font-size: 90%; min-width: 100%; text-align: justify; >', "</div>", true);
    //    var holder = "";
    //    if (forWrite[0] == "New Page") {
    //        //Process current page
    //        if (forWrite[1] > 0) {
    ...
    //    for (i = 0; i < value.length; i++) {
    //        var forWrite = $scope.generatePrintLines(value[i].Description, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="font-size: 90%;  min-width: 100%; text-align: justify;">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //        var schoolHTML = "", degreeHTML = "", addressHTML = "";
    //        if (i == 0) {
    //            schoolHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Post Graduate:</td><td style="width: auto;">UserSchool</td></tr></table>\n';
    //        }
    //        else {
    //            schoolHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserSchool</td></tr></table>\n';
    //        }
    //        degreeHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserDegree</td></tr></table>\n';

    //        addressHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserAddress</td></tr></table>\n';
    //        //Generate lines per user school
    //        var forWrite = $scope.generatePrintLines(user.PostGraduates[i].School, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify; ">', "</div>");
    ...
    //        }
    //        //Generate lines per user degree
    //        var forWrite = $scope.generatePrintLines(user.PostGraduates[i].Degree, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify; ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //        //Generate lines per user Address
    //        var forWrite = $scope.generatePrintLines(user.PostGraduates[i].Address, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //        //Generate lines per user Achievement
    //        if (user.PostGraduates[i].Achievement != null && user.PostGraduates[i].Achievement.trim() != '') {
    //            var forWrite = $scope.generateLines(user.PostGraduates[i].Achievement, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //            var holder = "";
    //            if (forWrite[0] == "New Page") {
    //                //Process current page
    //                if (forWrite[1] > 0) {
    ...
    //                        if (j == 0) {
    //                            holder = holder + forWrite[3].Lines[j];
    //                            achievementHTML = achievementHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Achievement/s:</td><td style="width: auto;">UserAchievement</td></tr></table>\n';
    //                            achievementHTML = achievementHTML.replace("UserAchievement", forWrite[3].Lines[j]);
    //                            $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + achievementHTML;
    //                        } else {
    //                            holder = holder + forWrite[3].Lines[j];
    //                            achievementHTML = achievementHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserAchievement</td></tr></table>\n';
    //                            achievementHTML = achievementHTML.replace("UserAchievement", forWrite[3].Lines[j]);
    //                            $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + achievementHTML;
    //                        }
    //                    }
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[4].Lines[j];
    //                        achievementHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Achievement/s:</td><td style="width: auto;">UserAchievement</td></tr></table>\n';
    //                        achievementHTML = achievementHTML.replace("UserAchievement", forWrite[4].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + achievementHTML;
    //                    } else {
    //                        holder = holder + forWrite[4].Lines[j];
    //                        achievementHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserAchievement</td></tr></table>\n';
    //                        achievementHTML = achievementHTML.replace("UserAchievement", forWrite[4].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + achievementHTML;
    //                    }
    //                }
    ...
    //        var schoolHTML = "", degreeHTML = "", addressHTML = "";
    //        if (i == 0) {
    //            schoolHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Tertiary:</td><td style="width: auto;">UserSchool</td></tr></table>\n';
    //        }
    //        else {
    //            schoolHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserSchool</td></tr></table>\n';
    //        }
    ...
    //        addressHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserAddress</td></tr></table>\n';
    //        //Generate lines per user school
    //        var forWrite = $scope.generatePrintLines(user.Tertiaries[i].School, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //        }
    //        //Generate lines per user degree
    //        var forWrite = $scope.generatePrintLines(user.Tertiaries[i].Degree, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //        //Generate lines per user Address
    //        var forWrite = $scope.generatePrintLines(user.Tertiaries[i].Address, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //        //Generate lines per user Achievement
    //        if (user.Tertiaries[i].Achievement != null && user.Tertiaries[i].Achievement.trim() != '') {
    //            var forWrite = $scope.generateLines(user.Tertiaries[i].Achievement, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //            var holder = "";
    //            if (forWrite[0] == "New Page") {
    //                //Process current page
    //                if (forWrite[1] > 0) {
    ...
    //        var schoolHTML = "", degreeHTML = "", addressHTML = "";
    //        if (i == 0) {
    //            schoolHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Secondary:</td><td style="width: auto;">UserSchool</td></tr></table>\n';
    //        }
    //        else {
    //            schoolHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserSchool</td></tr></table>\n';
    //        }
    //        addressHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserAddress</td></tr></table>\n';
    //        //Generate lines per user school
    //        var forWrite = $scope.generatePrintLines(user.Secondaries[i].School, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    ...
    //        //Generate lines per user Address
    //        var forWrite = $scope.generatePrintLines(user.Secondaries[i].Address, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //        //Generate lines per user Achievement
    //        if (user.Secondaries[i].Achievement != null && user.Secondaries[i].Achievement.trim() != '') {
    //            var forWrite = $scope.generateLines(user.Secondaries[i].Achievement, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //            var holder = "";
    //            if (forWrite[0] == "New Page") {
    //                //Process current page
    //                if (forWrite[1] > 0) {
    ...
    //        var schoolHTML = "", degreeHTML = "", addressHTML = "";
    //        if (i == 0) {
    //            schoolHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Primary:</td><td style="width: auto;">UserSchool</td></tr></table>\n';
    //        }
    //        else {
    //            schoolHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserSchool</td></tr></table>\n';
    //        }
    //        addressHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserAddress</td></tr></table>\n';
    //        //Generate lines per user school
    //        var forWrite = $scope.generatePrintLines(user.Primaries[i].School, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    ...
    //        //Generate lines per user Address
    //        var forWrite = $scope.generatePrintLines(user.Primaries[i].Address, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //        //Generate lines per user Achievement
    //        if (user.Primaries[i].Achievement != null && user.Primaries[i].Achievement.trim() != '') {
    //            var forWrite = $scope.generateLines(user.Primaries[i].Achievement, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //            var holder = "";
    //            if (forWrite[0] == "New Page") {
    //                //Process current page
    //                if (forWrite[1] > 0) {
    ...
    //        var companyHTML = "", addressHTML = "", periodHTML = "", positionHTML = "", mainRoleHTML = "";
    //        //Generate lines per company
    //        var forWrite = $scope.generatePrintLines(user.WorkExperiences[i].Company, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        companyHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Company:</td><td style="width: auto;">UserCompany</td></tr></table>\n';
    //                        companyHTML = companyHTML.replace("UserCompany", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + companyHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        companyHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserCompany</td></tr></table>\n';
    //                        companyHTML = companyHTML.replace("UserCompany", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + companyHTML;
    //                    }
    //                }
    ...
    //        //Generate lines per Address
    //        var forWrite = $scope.generatePrintLines(user.WorkExperiences[i].Address, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        addressHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Address:</td><td style="width: auto;">UserAddress</td></tr></table>\n';
    //                        addressHTML = addressHTML.replace("UserAddress", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + addressHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    ...
    //        }
    //        //Generate lines per Period
    //        var forWrite = $scope.generatePrintLines(user.WorkExperiences[i].Period, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        periodHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Period:</td><td style="width: auto;">UserPeriod</td></tr></table>\n';
    //                        periodHTML = periodHTML.replace("UserPeriod", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + periodHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        periodHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserPeriod</td></tr></table>\n';
    //                        periodHTML = periodHTML.replace("UserPeriod", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + periodHTML;
    //                    }
    //                }
    ...
    //        }
    //        //Generate lines per Position
    //        var forWrite = $scope.generatePrintLines(user.WorkExperiences[i].Position, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        positionHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Position:</td><td style="width: auto;">UserPosition</td></tr></table>\n';
    //                        positionHTML = positionHTML.replace("UserPosition", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + positionHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        positionHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserPosition</td></tr></table>\n';
    //                        positionHTML = positionHTML.replace("UserPosition", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + positionHTML;
    //                    }
    //                }
    ...
    //        //Generate lines per MainRole
    //        var forWrite = $scope.generatePrintLines(user.WorkExperiences[i].MainRole, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        mainRoleHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Main Role:</td><td style="width: auto;">UserMainRole</td></tr></table>\n';
    //                        mainRoleHTML = mainRoleHTML.replace("UserMainRole", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + mainRoleHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        mainRoleHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">UserMainRole</td></tr></table>\n';
    //                        mainRoleHTML = mainRoleHTML.replace("UserMainRole", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + mainRoleHTML;
    //                    }
    //                }
    ...
    //        var nameHTML = "", descriptionHTML = "", periodHTML = "";
    //        //Generate lines per name
    //        var forWrite = $scope.generatePrintLines(user.Trainings[i].Name, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        nameHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Name:</td><td style="width: auto;">STName</td></tr></table>\n';
    //                        nameHTML = nameHTML.replace("STName", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + nameHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        nameHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">STName</td></tr></table>\n';
    //                        nameHTML = nameHTML.replace("STName", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + nameHTML;
    //                    }
    //                }
    ...
    //        //Generate lines per Description
    //        var forWrite = $scope.generatePrintLines(user.Trainings[i].Description, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        addressHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Description:</td><td style="width: auto;">STDescription</td></tr></table>\n';
    //                        addressHTML = addressHTML.replace("STDescription", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + addressHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        addressHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">STDescription</td></tr></table>\n';
    //                        addressHTML = addressHTML.replace("STDescription", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + addressHTML;
    //                    }
    //                }
    ...
    //        //Generate lines per Period
    //        var forWrite = $scope.generatePrintLines(user.Trainings[i].Period, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        periodHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Period:</td><td style="width: auto;">STPeriod</td></tr></table>\n';
    //                        periodHTML = periodHTML.replace("STPeriod", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + periodHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        periodHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">STPeriod</td></tr></table>\n';
    //                        periodHTML = periodHTML.replace("STPeriod", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + periodHTML;
    //                    }
    //                }
    ...
    //        var nameHTML = "", professionHTML = "", contactHTML = "";
    //        //Generate lines per name
    //        var forWrite = $scope.generatePrintLines(user.CharacterReferences[i].Name, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        nameHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Name:</td><td style="width: auto;">CRName</td></tr></table>\n';
    //                        nameHTML = nameHTML.replace("CRName", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + nameHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        nameHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">CRName</td></tr></table>\n';
    //                        nameHTML = nameHTML.replace("CRName", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + nameHTML;
    //                    }
    //                }
    ...
    //        //Generate lines per Profession
    //        var forWrite = $scope.generatePrintLines(user.CharacterReferences[i].Profession, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        professionHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Profession:</td><td style="width: auto;">CRProfession</td></tr></table>\n';
    //                        professionHTML = professionHTML.replace("CRProfession", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + professionHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        professionHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">CRProfession</td></tr></table>\n';
    //                        professionHTML = professionHTML.replace("CRProfession", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + professionHTML;
    //                    }
    //                }
    ...
    //        }
    //        //Generate lines per contactHTML
    //        var forWrite = $scope.generatePrintLines(user.CharacterReferences[i].ContactNo, $scope.currentLines, maxNoOfLines, maxCharacter, '<div style="min-width: 100%; text-align: justify;  ">', "</div>");
    //        var holder = "";
    //        if (forWrite[0] == "New Page") {
    //            //Process current page
    //            if (forWrite[1] > 0) {
    ...
    //                    if (j == 0) {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        contactHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;">Contact:</td><td style="width: auto;">CRContact</td></tr></table>\n';
    //                        contactHTML = contactHTML.replace("CRContact", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + contactHTML;
    //                    } else {
    //                        holder = holder + forWrite[3].Lines[j];
    //                        contactHTML = '<table><tr style="font-size: 90%;  text-align:justify;"><td style="width: 110px; font-weight: bold; margin-left: 10px;"></td><td style="width: auto;">CRContact</td></tr></table>\n';
    //                        contactHTML = contactHTML.replace("CRContact", forWrite[3].Lines[j]);
    //                        $scope.contentPrintHtml[$scope.pageCount] = $scope.contentPrintHtml[$scope.pageCount] + contactHTML;
    //                    }
    //                }
    ...
    $scope.templateOnePrint = function (user, maxNoOfLines) {
        ...
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:100%' + ';">' + $scope.templateContainer[0].Content.join("\n") + "</div>";
        else if($scope.resume.FontFamily == "cursive")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:90%' + ';">' + $scope.templateContainer[0].Content.join("\n") + "</div>";
        else
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:95%' + ';">' + $scope.templateContainer[0].Content.join("\n") + "</div>";
        ...
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace($rootScope.baseUrl + "ResumeList/kennethcarlnacuaybanez/carl.jpg", $rootScope.baseUrl + user.ImageName);
        //$scope.currentLines = 0;
        //$scope.contentPrintHtml = [];
        //$scope.pageCount = 1;
        ////Initialize User Image
        //$scope.contentPrintHtml[$scope.pageCount] = '<table><tr><td style="padding-right: 60px;"><img src="UserImage" width="100" height="100"></td><td>' + "\n";
        ...
        ////Inialize User Objective
        //$scope.initializePrintObjective(user, maxNoOfLines, 90);
        //$scope.writePrintNewLine(true, maxNoOfLines);
        //$scope.writePrintHeaderContent(true, maxNoOfLines, "PERSONAL INFORMATION");
        ////Initialize User Birthdate
        //user.DateOfBirth = $filter('date')(user.DateOfBirth, "MMMM dd, yyyy");
        //$scope.writePrintContent(false, maxNoOfLines, "Birthdate", user.DateOfBirth, 90);
        ////Initialize User Age
        //$scope.writePrintContent(false, maxNoOfLines, "Age", user.Age, 90);
        ////Initialize User Gender
        //$scope.writePrintContent(false, maxNoOfLines, "Gender", user.Gender, 90);
        ////Initialize User Civil Status
        //$scope.writePrintContent(false, maxNoOfLines, "Civil Status", user.CivilStatus, 90);
        ////Initialize User Height
        //$scope.writePrintContent(false, maxNoOfLines, "Height", user.Height, 90);
        ////Initialize User Weight
        //$scope.writePrintContent(false, maxNoOfLines, "Weight", user.Weight, 90);
        ////Initialize User Citizenship
        //$scope.writePrintContent(false, maxNoOfLines, "Citizenship", user.Citizenship, 90);
        //$scope.writePrintNewLine(true, maxNoOfLines);
        //$scope.writePrintHeaderContent(true, maxNoOfLines, "HOBBIES");
        ////Inialize User Hobbies
        //$scope.initializePrintHobbies(user, maxNoOfLines, 90);
        //$scope.writePrintNewLine(true, maxNoOfLines);
        //if (user.Skills.length > 0 || user.Strengths > 0) {
        ...
        //$scope.htmlForDownload = $scope.htmlForDownload.split('<td style="width: 110px; font-weight: bold; margin-left: 10px;"></td>').join('<td style="width: 110px; font-weight: bold; margin-left: 10px;"></td>');
    ...
    $scope.templateTwoPrint = function (user, maxNoOfLines) {
        //Write Print Content
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:100%' + ';">' + $scope.templateContainer[1].Content.join("\n") + "</div>";
        else if ($scope.resume.FontFamily == "cursive")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:90%' + ';">' + $scope.templateContainer[1].Content.join("\n") + "</div>";
        else
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:95%' + ';">' + $scope.templateContainer[1].Content.join("\n") + "</div>";
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace('width="50"', 'width="100"');
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace('height="50"', 'height="100"');
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif") {
            document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.split('"line line-label"').join('"line-label-document"');
    ...
    $scope.templateThreePrint = function (user, maxNoOfLines) {
        //Write Print Content
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:100%' + ';">' + $scope.templateContainer[2].Content.join("\n") + "</div>";
        else if ($scope.resume.FontFamily == "cursive")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:90%' + ';">' + $scope.templateContainer[2].Content.join("\n") + "</div>";
        else
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:95%' + ';">' + $scope.templateContainer[2].Content.join("\n") + "</div>";
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace('width="50"', 'width="100"');
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace('height="50"', 'height="100"');
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif") {
            document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.split('"line line-label"').join('"line-label-document"');
    ...
    $scope.templateFourPrint = function (user, maxNoOfLines) {
        //Write Print Content
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:100%' + ';">' + $scope.templateContainer[3].Content.join("\n") + "</div>";
        else if ($scope.resume.FontFamily == "cursive")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:90%' + ';">' + $scope.templateContainer[3].Content.join("\n") + "</div>";
        else
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:95%' + ';">' + $scope.templateContainer[3].Content.join("\n") + "</div>";
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace('width="50"', 'width="100"');
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace('height="50"', 'height="100"');
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif") {
            document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.split('"line line-label"').join('"line-label-document"');
    ...
    $scope.templateFivePrint = function (user, maxNoOfLines) {
        //Write Print Content
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:100%' + ';">' + $scope.templateContainer[4].Content.join("\n") + "</div>";
        else if ($scope.resume.FontFamily == "cursive")
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:90%' + ';">' + $scope.templateContainer[4].Content.join("\n") + "</div>";
        else
            document.getElementById("PrintDocument").innerHTML = '<div style="text-align: justify; line-height: 20px; font-family:' + $scope.resume.FontFamily + '; font-size:95%' + ';">' + $scope.templateContainer[4].Content.join("\n") + "</div>";
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace('width="50"', 'width="100"');
        document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.replace('height="50"', 'height="100"');
        if ($scope.resume.FontFamily == "monospace" || $scope.resume.FontFamily == "serif") {
            document.getElementById("PrintDocument").innerHTML = document.getElementById("PrintDocument").innerHTML.split('"line line-label"').join('"line-label-document"');
    ...
    var doTheMath = $interval(function () {
        ...
        var fontSize = 0, fontSize1 = 0, padding = 0;
       
        //Calculate user age
        if ($filter('date')(document.getElementById("dateOfBirthValue").value, "MM dd yyyy").toString().split(" ").length == 3) {
            var currentDateMonth = $filter('date')(new Date(), "MM dd yyyy").toString().split(" ")[0];
            var currentDateDate = $filter('date')(new Date(), "MM dd yyyy").toString().split(" ")[1];
            var currentDateYear = $filter('date')(new Date(), "MM dd yyyy").toString().split(" ")[2];
            var userBirthdateMonth = $filter('date')(document.getElementById("dateOfBirthValue").value, "MM dd yyyy").toString().split(" ")[0];
            var userBirthdateDate = $filter('date')(document.getElementById("dateOfBirthValue").value, "MM dd yyyy").toString().split(" ")[1];
            var userBirthdateYear = $filter('date')(document.getElementById("dateOfBirthValue").value, "MM dd yyyy").toString().split(" ")[2];
            if (parseInt(currentDateMonth) > parseInt(userBirthdateMonth))
                $scope.resume.Age = currentDateYear - userBirthdateYear;
            else if (parseInt(currentDateMonth) < parseInt(userBirthdateMonth))
                $scope.resume.Age = (currentDateYear - userBirthdateYear) - 1;
            else {
                if (parseInt(userBirthdateDate) == parseInt(currentDateDate) || parseInt(currentDateDate) > parseInt(userBirthdateDate))
                    $scope.resume.Age = currentDateYear - userBirthdateYear;
                else
                    $scope.resume.Age = (currentDateYear - userBirthdateYear) - 1;
            }
        ...
        //Set font family
        document.getElementById("c-content").style.fontFamily = $scope.resume.FontFamily;
        //Set font size
